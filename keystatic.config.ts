  ...
  singletons: {
    siteProfile: singleton({
      ...
      schema: {
        ...
        advisor: fields.text({ label: 'Advisor Name' }),
        advisorChinese: fields.text({ label: 'Advisor Name (Chinese)' }),
        advisorRole: fields.text({ label: 'Advisor Role' }),
        advisorAvatar: fields.text({ label: 'Advisor Avatar' }),
        advisorAffiliation: fields.text({ label: 'Advisor Affiliation' }),
        advisorEmail: fields.text({ label: 'Advisor Email' }),
